...
$("#add-city").on("click", function(event) {
    ...
    function eventBriteInfo() {
        ...
        $.ajax({
            ...
            var results = response;
            console.log("eventbrite results: " + JSON.stringify(results));
            console.log("eventbrite results.events: " + JSON.stringify(results.events));
            console.log("eventbrite results.events[0]: " + JSON.stringify(results.events[0]));
            console.log("eventbrite results.event[0].logo.url: " + JSON.stringify(results.events[0].logo.url));
